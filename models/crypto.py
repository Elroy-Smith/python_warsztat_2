...
letters and digits.
"""
ALPHABET = 'ąśżźćłó' + string.ascii_uppercase + string.ascii_lowercase + string.digits
...
if __name__ == "__main__":
    print(ALPHABET)
    hashed_password = password_hash("abc", "123")
    hashed_password2 = password_hash("abc", "456")
    print(hashed_password , hashed_password2, sep='\n')
